...
ctrl_tf_state = {'num': np.array([ 0.01699776, -0.01699574]), 'den': np.array([ 1.        , -1.98300122,  0.98300325])}
ctrl_tf_state_dot = {'num': np.array([0.02120061]), 'den': np.array([ 1.        , -0.97879939])}
