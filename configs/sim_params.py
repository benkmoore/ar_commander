...
time_threshold = 1                         # time threshold about final trajectory time at which we signal last waypoint flag

# controller gains: Kp = 1.0, Ki = 0.01, Kd = 0.25, rate = 10 Hz see: AR1-192
